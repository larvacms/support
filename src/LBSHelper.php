...
class LBSHelper
{
     ...
     */
    public static function getCenterFromDegrees($points)
    {
     ...
     * @return bool
     */
    private static function isChina($longitude, $latitude)
    {
        return ($longitude < 72.004 || $longitude > 137.8347) || (($latitude < 0.8293 || $latitude > 55.8271) || false);
    }

    private static function transFormLatitude($longitude, $latitude)
    {
    ...
    private static function transFormLongitude($longitude, $latitude)
    {
